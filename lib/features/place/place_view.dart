...
class PlaceScreens extends StatelessWidget {
      ...
      body: BlocProvider(
        ...
        child: BlocConsumer<EgytologiaCubit,EgytologiaPlaceStates>(
          ...
          builder:(context, state){
            var model=EgytologiaCubit.get(context).modelPlace;
            return ConditionalBuilder(
              condition:model != null ?? null ,
              builder: (context)=>PlaceView(EgytologiaCubit.get(context).modelPlace, height,context),
  ...
  Widget PlaceView(ModelPlace modelPlace, double height,BuildContext context){
        ...
        Padding(
          ...
          child: Container(
            child: ListView.builder(
              ...
              itemCount:modelPlace.name.length,
            ),
          ),
        ),
        Container(
